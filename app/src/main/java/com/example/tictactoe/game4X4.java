...
public class game4X4 extends AppCompatActivity implements View.OnClickListener {
    ...
    String[][] savedbutton =new String[3][3];
    String A, B, pl1, pl2, winner = "",loser="";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_game4_x4);
    ...
    public void onClick(View v) {
        ...
        for (int k = 0; k < 4; k++) {
            for (int j = 0; j < 4; j++) {
                if (((buttons[k][0]).getText().toString().equals(buttons[k][1].getText().toString())) && ((buttons[k][0]).getText().toString().equals(buttons[k][2].getText().toString())) && (!buttons[k][0].getText().toString().isEmpty()) && ((buttons[k][0]).getText().toString().equals(buttons[k][3].getText().toString()))) {
                    ...
                    break;
                } else if (((buttons[0][k]).getText().toString().equals(buttons[1][k].getText().toString())) && ((buttons[0][k]).getText().toString().equals(buttons[2][k].getText().toString())) && (!buttons[0][k].getText().toString().isEmpty()) && ((buttons[0][k]).getText().toString().equals(buttons[3][k].getText().toString()))) {
                    ...
                    break;
                } else if ((buttons[0][0].getText().toString().equals(buttons[1][1].getText().toString())) && (buttons[0][0].getText().toString().equals(buttons[2][2].getText().toString())) && (!buttons[0][0].getText().toString().isEmpty()) && (buttons[0][0].getText().toString().equals(buttons[3][3].getText().toString()))) {
                    ...
                    break;
                } else if ((buttons[0][3].getText().toString().equals(buttons[1][2].getText().toString())) && (buttons[0][3].getText().toString().equals(buttons[3][0].getText().toString())) && (!buttons[0][3].getText().toString().isEmpty()) && (buttons[0][3].getText().toString().equals(buttons[2][1].getText().toString()))) {
                    if (buttons[0][0].getText().toString().equals(pl1)) {
                        winner = A;
                        loser=B;
                        Toast.makeText(getApplicationContext(), A + "wins!", Toast.LENGTH_SHORT).show();
                    ...
                    (buttons[0][3]).setBackgroundColor(R.drawable.title);
                    (buttons[1][2]).setBackgroundColor(R.drawable.title);
                    (buttons[2][1]).setBackgroundColor(R.drawable.title);
                    (buttons[3][0]).setBackgroundColor(R.drawable.title);
                    break;
                }
        ...
        if (!winner.isEmpty()) {
            ...
            m.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent p = new Intent(game4X4.this, finalpage.class);
